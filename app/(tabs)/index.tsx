...
export default function ChatScreen() {
  ...
  const { selectedModel, webSearchEnabled } = useAppSettings();
  ...
  const handleUpload = async (file: any) => {
    ...
    if (file.type?.startsWith('image/')) {
      prompt = `I'm sharing an image with you. The image is located at: ${file.uri}. Please analyze this image and describe what you see.`;
    } else {
      prompt = `I'm sharing a document with you. The document is named: ${file.name}. Please help me understand or analyze this document.`;
    }
            ...
            {(isLoading || isSearching) && (
              <View style={styles.loadingContainer}>
                ...
                <Text style={[
                  ...
                  {isSearching ? 'Searching the web...' : 'Keshav is thinking...'}
                </Text>
              </View>
            )}
          </Animated.ScrollView>
